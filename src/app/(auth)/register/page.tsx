  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#030303] flex items-center justify-center p-6 py-20">
      ...
      <div className="w-full max-w-4xl relative">
        <div className="flex flex-col items-center mb-8 md:mb-12 text-center animate-in fade-in slide-in-from-bottom-5 duration-700">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] md:text-xs font-black uppercase tracking-widest mb-4 md:mb-6">
          ...
          <p className="text-zinc-500 font-medium text-sm md:text-base max-w-lg mx-auto px-4">
            Everything you need to manage bookings, guests, and revenue in one powerful, multi-tenant dashboard.
          </p>
        </div>

        <div className="glass-panel relative overflow-hidden rounded-[2rem] md:rounded-[3rem] border border-white/10 bg-white/5 p-6 md:p-12 backdrop-blur-3xl animate-in fade-in zoom-in-95 duration-700 delay-100 shadow-2xl shadow-black/50">
