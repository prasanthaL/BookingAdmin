...
import { CreditCard, Rocket, Zap, ShieldCheck, Check } from "lucide-react";
...
export default function UpgradePage() {
  const plans = [
    ...
    },
    {
      ...
      features: ["Unlimited Rooms", "Unlimited Users", "Advanced Analytics", "Priority Support", "Custom Add-ons"],
      color: "emerald",
      popular: true,
    },
    {
      ...
      features: ["Multi-branch Support", "SLA Guarantee", "Dedicated Account Manager", "White-label Options"],
      color: "purple",
    },
  ];
            ...
            <div className="space-y-4 mb-10 flex-grow">
              {plan.features.map((feature) => (
                <div key={feature} className="flex items-center gap-3 text-sm font-medium text-zinc-300">
                  <div className={`flex-shrink-0 h-5 w-5 rounded-full flex items-center justify-center ${plan.popular ? 'bg-blue-500' : 'bg-zinc-800'}`}>
